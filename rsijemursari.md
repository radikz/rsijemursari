...
This privacy policy applies to the RSI Jemursari Surabaya Online app (hereby referred to as "Application") for mobile devices that was created by RSI Jemursari Surabaya (hereby referred to as "Service Provider") as a Free service. This service is intended for use "AS IS".
